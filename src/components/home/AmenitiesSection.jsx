...
export default function AmenitiesSection({ onOpenWizard }) {
  return (
    <section id="amenities" className="py-20 sm:py-28 bg-[#eef5fb] dark:bg-[#071322] transition-colors" aria-labelledby="amenities-heading">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-20">
          ...
          <div className="card-thick-hover rounded-3xl overflow-hidden group flex flex-col justify-between bg-white dark:bg-[#0e233c] border-2 border-[#d2e3f3] dark:border-[#17365d]">
        ...
        {/* PAYROT SECTION 3: Curved Deep Navy Banner with Floating 3D Orb */}
        <div className="relative pt-12">
          {/* Floating 3D Orb at Top Notch (Matches PAYROT Globe) */}
          <div className="absolute top-0 left-1/2 -translate-x-1/2 z-20">
            <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-[#1d77ff] via-sky-400 to-blue-700 p-1 shadow-2xl shadow-blue-500/50 border-4 border-[#eef5fb] dark:border-[#071322] animate-float flex items-center justify-center">
              <div className="w-full h-full rounded-full bg-[#0c1e33]/30 backdrop-blur-xs flex items-center justify-center text-white text-3xl">
                🦷
              </div>
            </div>
          </div>

          {/* Deep Navy Curved Block */}
          <div className="rounded-[3rem] bg-[#0c1e33] text-white pt-20 pb-16 px-8 sm:px-14 shadow-2xl border-2 border-[#17365d] relative overflow-hidden text-center max-w-5xl mx-auto">
            <div className="absolute top-0 right-0 w-96 h-96 bg-[#1d77ff]/15 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-4">
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  ...
                  className="px-9 py-4 rounded-full bg-[#1d77ff] hover:bg-[#1565e6] text-white font-black text-sm uppercase tracking-wider transition-all shadow-xl shadow-blue-500/30 hover:scale-105 active:scale-95 flex items-center space-x-2"
                >
